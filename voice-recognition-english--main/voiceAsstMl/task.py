...
def ss():
    ...
    fname = takeCommand()
    path = fname + ".jpg"
    fullpath = "C://Users//DeLL//OneDrive//Pictures//Screenshots" + path
...
def openApp(query):
      ...
      if "open camera" in query:
          os.startfile("C://Windows//servicing//LCU//Package_for_RollupFix~31bf3856ad364e35~amd64~~19041.2364.1.4//amd64_microsoft-windows-webcamexperience_31bf3856ad364e35_10.0.19041.1806_none_e167c28b61357cb2\r")
          Spk.say("done sir")
      ...
      if "control panel" in query:
          os.startfile("search-ms:displayname=Search%20Results%20in%20System32&crumb=filename%3A~<control.exe%20OR%20System.Generic.String%3Acontrol.exe&crumb=location:C%3A%5CWindows%5CSystem32")
          Spk.say("done sir....")
      if "notepad" in query:
...
def msgWhatsappp():
    ...
    if "vivek" in name:
        ...
        pywhatkit.sendwhatmsg("+917999889672",msg,hour,minute,20)
        ...
        Spk.say("tell me the time in minute")
        minute = int(takeCommand())
        pywhatkit.sendwhatmsg("+919406206854", msg, hour, minute, 20)
        Spk.say("ok sir! sending whatsapp massage")
